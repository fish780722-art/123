...
def main() -> None:
    ...
    result = run_backtest(price_data, int(short_window), int(long_window), float(initial_capital))
    ...
    st.plotly_chart(
        build_price_chart(result.data, symbol, int(short_window), int(long_window)),
        use_container_width=True,
    )
    st.plotly_chart(build_equity_chart(result.data), use_container_width=True)
    st.plotly_chart(build_drawdown_chart(result.data), use_container_width=True)
